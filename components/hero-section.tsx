    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "40vw",
          background:
            "radial-gradient(ellipse, rgba(188,19,254,0.06) 0%, transparent 70%)",
          zIndex: 0,
        }}
        aria-hidden="true"
      />
          ...
          >
            ...
            <div
              ...
              style={{
                inset: "10%",
                background:
                  "radial-gradient(ellipse, rgba(188,19,254,0.08) 0%, transparent 65%)",
                zIndex: 0,
                filter: "blur(20px)",
              }}
              aria-hidden="true"
      ...
      <div
        ...
        style={{
          // background:
          //   "linear-gradient(to bottom, transparent, rgba(10,10,15,0.5))",
          zIndex: 5,
        }}
        aria-hidden="true"
      />
