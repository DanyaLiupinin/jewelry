    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderBottom: "1px solid rgba(232,230,224,0.06)",
        }}
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 pt-32 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="relative">
            ...
            >
              <div
                style={{
                  paddingBottom: product.aspect === "portrait" ? "125%" : "75%",
                  position: "relative",
                }}
              >
                <Image
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at center, rgba(188,19,254,0.04) 0%, transparent 60%)",
                zIndex: -1,
              }}
              aria-hidden="true"
            />
        ...
        <div
          ...
          style={{ borderTop: "1px solid rgba(232,230,224,0.06)" }}
        >
          <h2
                ...
                >
                  ...
                  >
                    <p
                      ...
                      style={{ color: "#e8e6e0", fontSize: "0.9rem" }}
                    >
                      {p.name}
                    </p>
                    <p
